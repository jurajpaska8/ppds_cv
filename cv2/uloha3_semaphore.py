from fei.ppds import print, Thread, Event, Semaphore
...
class FibonacciShared:
    def __init__(self, size):
        ...
        self.sync_object_list = [Semaphore(0) for _ in range(size - 2)]
        # self.sync_object_list = [Event() for _ in range(size - 2)]
